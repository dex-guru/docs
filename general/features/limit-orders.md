...
A limit order has a target price and an expiration date. It is a request to buy or sell a token at a specific price that you can specify. A limit order is not filled unless the price reaches your target price during the specified time.
